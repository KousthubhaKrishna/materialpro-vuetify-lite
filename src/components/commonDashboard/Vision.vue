<template>
  ...
  <v-card outlined class="my-5">
    <v-row class = "pa-5">
      <v-col align="right">
        <h2 class="primary--text text--darken-1">Vision</h2>
      </v-col>
      <v-col>
        {{ vision }}
      </v-col>
    ...
    <v-row class = "pa-5">
      ...
      <v-col>
        <h2 class="primary--text text--darken-1">Mission</h2>
      </v-col>
    </v-row>
  </v-card>
  <v-card maxWidth="1000" outlined>
    <v-row align="center" justify="center">
        <v-card-title>
        <h3 class="green--text text-justify text--darken-2 pa-5"> We’re talking Self-Enlightenment. </h3>
        </v-card-title>
    </v-row>
            <v-card-text>
